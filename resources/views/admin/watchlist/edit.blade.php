...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Watchlist Entry</h4>
                <p class="card-description">Update the details of the watchlist person</p>

                <form class="forms-sample" action="{{ route('admin.watchlist.update', $watchlist->id) }}" method="POST">
                    @csrf
                    @method('PUT')
