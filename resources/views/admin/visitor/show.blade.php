                            ...
                            <div class="img-cards" id="printidcard">
                                <div class="id-card-holder">
                                    <div class="id-card">
                                        ...
                                        <h3>{{__('visitor.ph')}}:{{$visitingDetails->visitor->country_code}}{{$visitingDetails->visitor->phone}}</h3>
			    	...
			    	<div class="card">
			    		<div class="card-body">
			    			<div class="profile-desc">
                                ...
                                @endif
                                <div class="single-profile">
			    					<p><b>Car Reg Number</b> {{ $visitingDetails->visitor->reg_car_no}}</p>
			    				</div>
			    			</div>
...
@section('scripts')
    ...
    <script>var idCardCss = "{{ asset('css/id-card-print.css') }}";</script>
