                        ...
                        <form action="{{ route('admin.visitors.update', $visitingDetails) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="reg_car_no">Car Register Number</label> 
                                        <input id="reg_car_no" type="text" name="reg_car_no" class="form-control" value="{{ old('reg_car_no',$visitingDetails->visitor->reg_car_no) }}">
                                    </div>
