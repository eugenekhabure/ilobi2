                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.deliveries.update', $delivery->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="facility_id" class="form-control @error('facility_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($facilities as $facility)
                                        <option value="{{ $facility->id }}" {{ old('facility_id', $delivery->facility_id) == $facility->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="courier_name" class="form-control @error('courier_name') is-invalid @enderror" value="{{ old('courier_name', $delivery->courier_name) }}">
                                @error('courier_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tracking_number" class="form-control @error('tracking_number') is-invalid @enderror" value="{{ old('tracking_number', $delivery->tracking_number) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="recipient_person_id" class="form-control @error('recipient_person_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($people as $person)
                                        <option value="{{ $person->id }}" {{ old('recipient_person_id', $delivery->recipient_person_id) == $person->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="sub_unit_id" class="form-control">
                                    ...
                                    @foreach($subUnits as $unit)
                                        <option value="{{ $unit->id }}" {{ old('sub_unit_id', $delivery->sub_unit_id) == $unit->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control @error('status') is-invalid @enderror" required>
                                    ...
                                    <option value="received" {{ old('status', $delivery->status) == 'received' ? 'selected' : '' }}>Received</option>
                                    <option value="rejected" {{ old('status', $delivery->status) == 'rejected' ? 'selected' : '' }}>Rejected</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label>Notes</label>
                                <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3">{{ old('notes', $delivery->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
