...
<section class="section">
    <div class="section-header">
        <h1>📹 Add Hikvision Device</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="{{ route('admin.hikvision.index') }}">Hikvision</a></div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.hikvision.store') }}">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Port</label>
                                        <input type="number" name="device_port" class="form-control @error('device_port') is-invalid @enderror" value="{{ old('device_port', 80) }}">
                                        @error('device_port')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.hikvision.index') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
