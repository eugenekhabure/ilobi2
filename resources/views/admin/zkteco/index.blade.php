...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a href="{{ route('admin.zkteco.create') }}" class="btn btn-primary">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @forelse($devices as $device)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.zkteco.edit', $device->id) }}" class="btn btn-sm btn-primary">
                                                    <i class="far fa-edit"></i>
                                                </a>
                                                <form action="{{ route('admin.zkteco.destroy', $device->id) }}" method="POST" style="display:inline;">
                                                    @csrf @method('DELETE')
                                    ...
                                    @empty
                                        <tr><td colspan="7" class="text-center">No ZKTeco devices found.</td></tr>
                                    @endforelse
                                </tbody>
                            </table>
                        </div>
