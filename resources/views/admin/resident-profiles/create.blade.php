...
@section('title', 'Create Resident Profile')
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.resident-profiles.store') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_owner" class="form-control">
                                    <option value="0" {{ old('is_owner') == '0' ? 'selected' : '' }}>No (Tenant)</option>
                                    <option value="1" {{ old('is_owner') == '1' ? 'selected' : '' }}>Yes (Owner)</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Create Resident Profile</button>
