...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Add Surveillance Camera</h4>
                <p class="card-description">Configure a new camera feed for surveillance</p>

                <form class="forms-sample" action="{{ route('admin.surveillance.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Enable to start recording automatically</small>
                            </div>
                        </div>
                    ...
                    <button type="submit" class="btn btn-gradient-primary me-2">Add Camera</button>
