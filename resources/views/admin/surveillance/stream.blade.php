...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Camera Stream - {{ $feed->name }}</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.surveillance.show', $feed->id) }}" class="btn btn-secondary btn-sm">
                            ...
                            @if($feed->status === 'online' || $feed->status === 'recording')
                                ...
                                <div class="mt-3">
                                    <div class="alert alert-info">
                                        ...
                                        @if($feed->is_recording)
                                            | <span class="text-danger"><i class="fas fa-circle"></i> Recording in progress</span>
                                        @endif
                                    </div>
                                </div>
                            @else
                                <div class="text-center py-5">
                                    <div class="alert alert-{{ $feed->status === 'error' ? 'danger' : 'warning' }}" style="padding: 60px 20px;">
                                        <i class="fas fa-{{ $feed->status === 'error' ? 'exclamation-triangle' : 'video-slash' }}" style="font-size: 48px;"></i>
