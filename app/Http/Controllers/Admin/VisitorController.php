...
class VisitorController extends BackendController
{
    ...
    */
    ...
    {   
        ...
        #echo "<pre>";print_r($this->data['visitingDetails']);die();
    ...
    public function getVisitor(Request $request)
    {
        ...
        return Datatables::of($visitingDetailArray)
            ...
            ##
            ->editColumn('reg_car_no', function ($visitingDetail) {

                if ($visitingDetail->visitor->reg_car_no) 
                {
                    return $visitingDetail->visitor->reg_car_no;
